...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoices.updateStatus', ['id' => $invoice->id]) }}" method="post" autocomplete="off">
                        @csrf
                        {{-- 1 --}}
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3" readonly>{{ $invoice->note }}</textarea></div>
                        </div><br>
