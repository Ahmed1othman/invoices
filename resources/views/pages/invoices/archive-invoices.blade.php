...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('messages.Invoices ِArchive List')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('messages.Invoices')}}</span>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="{{ route('invoices.deleteArchiveInvoices') }}" method="post">
                        @csrf
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="{{ route('invoices.restoreArchiveInvoices') }}" method="post">
                        {{ csrf_field() }}
                    </div>
                    <div class="modal-body">
