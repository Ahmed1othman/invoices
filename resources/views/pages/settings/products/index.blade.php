...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('messages.Setting')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('products.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label class="my-1 mr-2" for="inlineFormCustomSelectPref">{{__('messages.Section Name')}}</label>
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <form action="{{route('products.delete')}}" method="post">
                        @csrf
                        <div class="modal-body">
                            <input type="hidden" id="without" name="without" value="without">
