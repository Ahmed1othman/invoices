    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoices.index')}}">{{__('messages.Invoices List')}}</a></li>
                    ...
                    <li><a class="slide-item" href="{{ route('invoices.partialInvoices') }}">الفواتير المدفوعة جزئيا</a></li>
                    <li><a class="slide-item" href="{{ route('invoices.archiveInvoices') }}">ارشيف الفواتير</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('reports.index')}}">تقارير الفواتير</a></li>
                    <li><a class="slide-item" href="{{route('customer.reports.index')}}">تقارير العملاء</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('admins.index') }}">قائمة المستخدمين</a></li>
                    @endcan
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ route('sections.index') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M15 11V4H4v8.17l.59-.58.58-.59H6z" opacity=".3"/><path d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z"/></svg><span class="side-menu__label">{{__('messages.Setting')}}</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    @can('الاقسام')
                    <li><a class="slide-item" href="{{ route('sections.index') }}">{{__('messages.Sections')}}</a></li>
                    @endcan
                    @can('المنتجات')
                    <li><a class="slide-item" href="{{ route('products.index') }}">{{__('messages.Products')}}</a></li>
                    @endcan
                </ul>
            </li>
            @endcan
