						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
                                        ...
                                        <div class="menu-header-content bg-primary text-right">
                                            <div class="d-flex">
                                                ...
                                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                                        href="{{route('invoices.notifications.markAllAsRead')}}">تعين قراءة الكل</a></span>
                                            </div>
                                            ...
                                            @foreach (auth()->user()->unreadNotifications as $notification)
                                                <div class="main-notification-list Notification-scroll">
                                                    <a class="d-flex p-3 border-bottom"
                                                       href="{{ url('invoices/details') }}/{{ $notification->data['invoice_id'] }}">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href=""><i class="bx bx-cog"></i>{{__('messages.Edit Profile')}}</a>
									<a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>{{__('messages.Inbox')}}</a>
									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>{{__('messages.Messages')}}</a>
									<a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i>{{__('messages.Account Settings')}}</a>
